...
-- ── 3. query_charts — 12 rows (4 per component: taipei + metrotaipei × two_d + map) ──
...
-- disaster_shelter row 3: two_d (taipei view — same NTPC data)
INSERT INTO query_charts (index, history_config, map_config_ids, map_filter, time_from, time_to, update_freq, update_freq_unit, source, short_desc, long_desc, use_case, links, contributors, created_at, updated_at, query_type, query_chart, query_history, city)
VALUES (
  'disaster_shelter',
  '{}'::json,
...
-- disaster_shelter row 4: map (taipei view — same NTPC data)
INSERT INTO query_charts (index, history_config, map_config_ids, map_filter, time_from, time_to, update_freq, update_freq_unit, source, short_desc, long_desc, use_case, links, contributors, created_at, updated_at, query_type, query_chart, query_history, city)
VALUES (
  'disaster_shelter',
  '{}'::json,
...
-- river_water_level row 3: bar chart (metrotaipei view — same TPE data)
INSERT INTO query_charts (index, history_config, map_config_ids, map_filter, time_from, time_to, update_freq, update_freq_unit, source, short_desc, long_desc, use_case, links, contributors, created_at, updated_at, query_type, query_chart, query_history, city)
VALUES (
  'river_water_level',
  '{}'::json,
...
-- river_water_level row 4: map (metrotaipei view — same TPE data)
INSERT INTO query_charts (index, history_config, map_config_ids, map_filter, time_from, time_to, update_freq, update_freq_unit, source, short_desc, long_desc, use_case, links, contributors, created_at, updated_at, query_type, query_chart, query_history, city)
VALUES (
  'river_water_level',
  '{}'::json,
...
-- slope_risk_tpe row 3: bar chart (metrotaipei view)
INSERT INTO query_charts (index, history_config, map_config_ids, map_filter, time_from, time_to, update_freq, update_freq_unit, source, short_desc, long_desc, use_case, links, contributors, created_at, updated_at, query_type, query_chart, query_history, city)
VALUES (
  'slope_risk_tpe',
  '{}'::json,
...
-- slope_risk_tpe row 4: map (metrotaipei view)
INSERT INTO query_charts (index, history_config, map_config_ids, map_filter, time_from, time_to, update_freq, update_freq_unit, source, short_desc, long_desc, use_case, links, contributors, created_at, updated_at, query_type, query_chart, query_history, city)
VALUES (
  'slope_risk_tpe',
  '{}'::json,
