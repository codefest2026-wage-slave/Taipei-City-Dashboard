...
food_safety_monthly_trend	{#3D8BFF,#FF7043}	{TimelineSeparateChart}	件
\.
...
219	food_safety_monthly_trend	月度食安稽查趨勢
\.
...
1200	food_safety_tracker_metrotaipei	食安風險追蹤器	{219}	security	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00
\.
...
food_safety_monthly_trend	\N	{}	{}	static	\N	\N	\N	衛福部食品藥物管理署	月度食品安全稽查趨勢（臺北市）	依月份統計臺北市食品安全稽查件數及違規率。藍線顯示當月抽檢總量，橘線顯示當月違規率（不合格件數佔總量百分比）。	可用於掌握臺北市食品安全稽查的月度趨勢，評估違規率隨時間的變化情形，作為稽查資源分配的參考依據。	{}	{}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	time	select\r\ndate_trunc('month', inspection_date::timestamp) as x_axis,\r\n'月抽檢總量' as y_axis,\r\ncount(*)::float as data\r\nfrom food_safety_inspection_metrotaipei\r\nwhere inspection_date is not null\r\nand city = '臺北市'\r\ngroup by 1\r\nunion all\r\nselect\r\ndate_trunc('month', inspection_date::timestamp) as x_axis,\r\n'違規率(%)' as y_axis,\r\nround(\r\ncount(*) filter (where inspection_result = '不合格')\r\n* 100.0 / nullif(count(*), 0), 1\r\n) as data\r\nfrom food_safety_inspection_metrotaipei\r\nwhere inspection_date is not null\r\nand city = '臺北市'\r\ngroup by 1\r\norder by 1, 2	\N	taipei
food_safety_monthly_trend	\N	{}	{}	static	\N	\N	\N	衛福部食品藥物管理署	月度食品安全稽查趨勢（新北市）	依月份統計新北市食品安全稽查件數及違規率。藍線顯示當月抽檢總量，橘線顯示當月違規率（不合格件數佔總量百分比）。	可用於掌握新北市食品安全稽查的月度趨勢，評估違規率隨時間的變化情形，作為稽查資源分配的參考依據。	{}	{}	2026-05-02 00:00:00+00	2026-05-02 00:00:00+00	time	select\r\ndate_trunc('month', inspection_date::timestamp) as x_axis,\r\n'月抽檢總量' as y_axis,\r\ncount(*)::float as data\r\nfrom food_safety_inspection_metrotaipei\r\nwhere inspection_date is not null\r\nand city = '新北市'\r\ngroup by 1\r\nunion all\r\nselect\r\ndate_trunc('month', inspection_date::timestamp) as x_axis,\r\n'違規率(%)' as y_axis,\r\nround(\r\ncount(*) filter (where inspection_result = '不合格')\r\n* 100.0 / nullif(count(*), 0), 1\r\n) as data\r\nfrom food_safety_inspection_metrotaipei\r\nwhere inspection_date is not null\r\nand city = '新北市'\r\ngroup by 1\r\norder by 1, 2	\N	newtaipei
