  ...
  <div class="rpr-root">
        ...
        >
          ...
          <div class="rpr-info">
            ...
            <div class="rpr-meta">
              ...
              <span
                v-if="row.disasters > 0"
                class="rpr-disaster"
              > · 職災 {{ row.disasters }}</span>
            </div>
          </div>
          <div
            class="rpr-score"
            :style="{ background: scoreColor(row.dynamic_score) }"
          >
    ...
    >
      ...
      <div class="rpr-ai-body">
        ...
        <div
          v-else-if="!explanation && !loading && !error"
          class="rpr-ai-hint"
        >
          <button
            class="rpr-ai-cta"
            @click="fetchExplanation(selected)"
          >
