-- Labor Safety Dashboard — Create Tables
-- Project: 工作安全燈號 (Labor Safety Radar)
-- Covers: Taipei City (tpe) + New Taipei City (ntpc)
-- Run: docker exec -i postgres-data psql -U postgres -d dashboard < scripts/labor_safety_create_tables.sql
